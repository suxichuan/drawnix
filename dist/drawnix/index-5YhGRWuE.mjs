...
import { g as Kn } from "./index-DR-sfp9y.mjs";
var jt;
(function(t) {
...
const At = (t) => {
  ...
  const l = At(u), a = e || i && l || "中心主题", m = Et(!0, !1, Ct(a)), s = zt(a, m.width, m.height, {
    layout: jt.right
  });
  ...
  const g = (S, y = !1) => {
    ...
    if (!(i && !e && S === u))
      if (S.type === "heading") {
        ...
        if (!_)
          return;
        const { width: N, height: x } = Et(!1, !1, Ct(_)), F = zt(_, N, x, {});
        ...
        if (!b)
          return;
        const { width: _, height: N } = Et(!1, !1, Ct(b)), x = zt(b, _, N, {});
        p.children.push(x);
      } else {
        const b = At(S);
        if (!b)
